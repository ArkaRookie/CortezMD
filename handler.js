/* Tanpa Ada Nya Creadit
    Contact Me
    • Wa : +62 895-3163-9634
    • IG  : @al_dev_1 
    • YT : Al Dev
Buy No Enc : Rp 60.000 (100% Work Fitur)
               Rp 100.000 (Free Update)
Enc : Di YT Al Dev / Hub Owner (Fitur Colongan Silahkan Fix Sendiri)
*/
...
module.exports = {
    async handler(chatUpdate) {
        ...
        if (m.mtype === "interactiveResponseMessage" && m.quoted.fromMe) this.appendTextMessage2(m, JSON.parse(m.msg.nativeFlowResponseMessage.paramsJson).id, chatUpdate)
...
text: 'Greetings!\n\n- This bot, designed specifically for group use, is available free of charge. It has been developed with the aim of providing valuable assistance to its users.\n\n- We deeply appreciate your generosity and support. Thank you! :D\n\n- _Contact Support_ :\n' + `@${nomorown.split("@")[0]}` + '```\n\n- Join the Official Bot Group for Free Access & Future Information about Bots :\n https://chat.whatsapp.com/BrsXR4ZheCn8WcFcWSzbMM\n\n> To support the development and maintenance of this bot, you can Report/Request, You can contact or join the group above. Thank you for your support!',
contextInfo: {
mentionedJid: [m.sender, nomorown],
externalAdReply: { showAdAttribution: true, 
title: `© Pokii - Kawaii v5.0.3 (Public Bot)`,

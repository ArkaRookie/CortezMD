...
let api = await Func.fetchJson(`https://api.alyachan.dev/api/filmget?url=${url}&apikey=${global.alya}`)
return api
}
async function film(text) {
let api = await Func.fetchJson(`https://api.alyachan.dev/api/film?q=${text}&apikey=${global.alya}`)
return api
}